...
public enum Message {
    CONNECTION_POOL_INITIALIZED("Der ConnectionPool wurde initialisiert. Dauerte %timestamp%ms", MessageLevel.SUCCESS),
    ...
    ERROR_DEFAULT_MYSQL_CONFIG("Die Default MySQL Config Datei konnte nicht erstellt werden.", MessageLevel.ERROR),
